...
class getLoginControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.erpk1LJ'] ?? $container->load('get_ServiceLocator_Erpk1LJService'))->withContext('App\\Controller\\LoginController', $container));
