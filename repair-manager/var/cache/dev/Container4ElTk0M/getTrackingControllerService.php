...
{
    /**
     * Gets the public 'App\Controller\TrackingController' shared autowired service.
     *
     * @return \App\Controller\TrackingController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/TrackingController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/RepairHistoryService.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-core/Security.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-bundle/Security.php';

        $container->services['App\\Controller\\TrackingController'] = $instance = new \App\Controller\TrackingController(new \App\Service\RepairHistoryService(($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)), new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
        ...
        ])]), ($container->privates['cache.app'] ?? $container->load('getCache_AppService'))), ($container->privates['App\\Repository\\RepairHistoryRepository'] ?? $container->load('getRepairHistoryRepositoryService')));

        $instance->setContainer(($container->privates['.service_locator.erpk1LJ'] ?? $container->load('get_ServiceLocator_Erpk1LJService'))->withContext('App\\Controller\\TrackingController', $container));
