...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\AuditLogController' => 'getAuditLogControllerService',
            'App\\Controller\\AuditTestController' => 'getAuditTestControllerService',
            ...
            'App\\Controller\\TrackingController' => 'getTrackingControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/AuditSubscriber.php';
            include_once \dirname(__DIR__, 4).'/src/Service/AuditService.php';
    ...
    protected static function get_Container_Private_ProfilerService($container)
    {
        ...
        $d->registerBus('command.bus', ($container->services['messenger.default_bus'] ?? self::getMessenger_DefaultBusService($container)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YQCahzfpyx', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RImZyrgKkw', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('j+X3BRyNp+', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDataCollector_CacheService($container)
    {
        ...
        $instance->addInstance('cache.adapter.filesystem', ($container->privates['cache.adapter.filesystem'] ?? self::getCache_Adapter_FilesystemService($container)));
    ...
    protected static function getDoctrine_Dbal_DefaultConnectionService($container)
    {
        ...
        $b->pushHandler(($container->privates['monolog.handler.error'] ?? self::getMonolog_Handler_ErrorService($container)));
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('security.interactive_login', [#[\Closure(name: 'App\\EventSubscriber\\AuditSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\AuditSubscriber'] ?? self::getAuditSubscriberService($container)), 'onLogin'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [#[\Closure(name: 'App\\EventSubscriber\\AuditSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\AuditSubscriber'] ?? self::getAuditSubscriberService($container)), 'onLogout'], 0);
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\EventSubscriber\\AuditSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\AuditSubscriber'] ?? self::getAuditSubscriberService($container)), 'onKernelRequest'], 0);
        $instance->addListener('kernel.response', [#[\Closure(name: 'App\\EventSubscriber\\AuditSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\AuditSubscriber'] ?? self::getAuditSubscriberService($container)), 'onKernelResponse'], 0);
        $instance->addListener('kernel.exception', [#[\Closure(name: 'App\\EventSubscriber\\AuditSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\AuditSubscriber'] ?? self::getAuditSubscriberService($container)), 'onKernelException'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b = new \Symfony\Bundle\FrameworkBundle\Controller\ControllerResolver($container, ($container->services['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container)));
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AuditLogController', 'App\\Controller\\AuditTestController', 'App\\Controller\\DashboardController', 'App\\Controller\\HomeController', 'App\\Controller\\LoginController', 'App\\Controller\\RoleController', 'App\\Controller\\SecurityController', 'App\\Controller\\StatusController', 'App\\Controller\\TrackingController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getMessenger_DefaultBusService($container)
    {
        return $container->services['messenger.default_bus'] = new \Symfony\Component\Messenger\TraceableMessageBus(new \Symfony\Component\Messenger\MessageBus(new RewindableGenerator(function () use ($container) {
            ...
            yield 5 => ($container->privates['command.bus.middleware.send_message'] ?? $container->load('getCommand_Bus_Middleware_SendMessageService'));
            yield 6 => ($container->privates['command.bus.middleware.handle_message'] ?? $container->load('getCommand_Bus_Middleware_HandleMessageService'));
        }, 7)));
    }
    ...
    protected static function getMonolog_Logger_RequestService($container)
    {
        ...
        $instance->pushHandler(($container->privates['monolog.handler.console'] ?? self::getMonolog_Handler_ConsoleService($container)));
        $instance->pushHandler(($container->privates['monolog.handler.error'] ?? self::getMonolog_Handler_ErrorService($container)));
        $instance->pushHandler(($container->privates['monolog.handler.request'] ?? self::getMonolog_Handler_RequestService($container)));
        $instance->pushHandler(($container->privates['monolog.handler.main'] ?? self::getMonolog_Handler_MainService($container)));
        ($container->privates['debug.debug_logger_configurator'] ?? self::getDebug_DebugLoggerConfiguratorService($container))->pushDebugLogger($instance);
    ...
    /**
     * Gets the private 'App\EventSubscriber\AuditSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\AuditSubscriber
     */
    protected static function getAuditSubscriberService($container)
    {
        return $container->privates['App\\EventSubscriber\\AuditSubscriber'] = new \App\EventSubscriber\AuditSubscriber(($container->privates['App\\Service\\AuditService'] ?? self::getAuditServiceService($container)), ($container->services['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container)));
    }

    /**
     * Gets the private 'App\Service\AuditService' shared autowired service.
     *
     * @return \App\Service\AuditService
     */
    protected static function getAuditServiceService($container)
    {
        return $container->privates['App\\Service\\AuditService'] = new \App\Service\AuditService(($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)), ($container->services['monolog.logger.audit'] ?? self::getMonolog_Logger_AuditService($container)), ($container->services['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));
    }

    /**
     * Gets the private 'cache.adapter.filesystem' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\TraceableAdapter
     */
    protected static function getCache_Adapter_FilesystemService($container)
    {
        return $container->privates['cache.adapter.filesystem'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NL55BEXdjv', 0, ($container->targetDir.''.'/pools')));
    }
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZhAarQL3qZ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('tQSBat5UK-', 0, ($container->targetDir.''.'/pools'));
        $a->setLogger(($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('M2dholxjdS', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XFJ+91tv49', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CAOalJi2rW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Xye961cH2J', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PRIQvrRU0p', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        return $container->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\EventListener\\RepairTrackingListener' => ['privates', 'App\\EventListener\\RepairTrackingListener', 'getRepairTrackingListenerService', true],
            ...
            'App\\EventListener\\RepairTrackingListener' => '?',
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AuditLogRepository' => ['privates', 'App\\Repository\\AuditLogRepository', 'getAuditLogRepositoryService', true],
            'App\\Repository\\RepairHistoryRepository' => ['privates', 'App\\Repository\\RepairHistoryRepository', 'getRepairHistoryRepositoryService', true],
            'App\\Repository\\RepairRepository' => ['privates', 'App\\Repository\\RepairRepository', 'getRepairRepositoryService', true],
            ...
            'App\\Repository\\RepairHistoryRepository' => '?',
            'App\\Repository\\RepairRepository' => '?',
    ...
    {
        return $container->privates['doctrine.result_cache_pool'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(new \Symfony\Component\Cache\Adapter\FilesystemAdapter('WS+aSAjJNK', 0, ($container->targetDir.''.'/pools')));
    }
    ...
    {
        return $container->privates['doctrine.system_cache_pool'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(new \Symfony\Component\Cache\Adapter\FilesystemAdapter('M7h9L4g2bx', 0, ($container->targetDir.''.'/pools')));
    }
    ...
    {
        $container->privates['monolog.handler.audit'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).'/log/audit.log'), 30, 'info', true, NULL, false);
    ...
    {
        $container->privates['monolog.handler.error'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).'/log/error.log'), 30, 'error', true, NULL, false);
    ...
    {
        $container->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).'/log/dev.log'), 10, 'debug', true, NULL, false);
    ...
    /**
     * Gets the private 'monolog.handler.request' shared service.
     *
     * @return \Monolog\Handler\RotatingFileHandler
     */
    protected static function getMonolog_Handler_RequestService($container)
    {
        $container->privates['monolog.handler.request'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).'/log/request.log'), 10, 'info', true, NULL, false);
    ...
    {
        $container->privates['monolog.handler.security'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).'/log/security.log'), 10, 'debug', true, NULL, false);
    ...
    {
        return $container->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($container->services['router'] ?? self::getRouterService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['router.request_context'] ?? self::getRouter_RequestContextService($container)), ($container->services['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container)), \dirname(__DIR__, 4), true);
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $f = ($container->privates['router.request_context'] ?? self::getRouter_RequestContextService($container));
